    ...
    <div>
        ...
        <div class="column-table pdbootom100" :class="[total>20?'pdbootom100':'']">
            <el-table ref="multipleTable" border :stripe="true" :data="list" style="width:100%">
                ...
                <el-table-column prop="address" label="居住区域"></el-table-column>
            </el-table>
        </div>
...
export default {
    ...
    data(){
        return{
            ...
            total:0,
            list:[
                {name:'程紫麟',sex:'男',relation:'母亲',phone:'18907052268',state:'1',school:'二七校区',address:'河南'},
                {name:'徐锦瑞',sex:'男',relation:'母亲',phone:'18907052268',state:'1',school:'二七校区',address:'安徽省亳州市'},
                {name:'司晨皓',sex:'男',relation:'母亲',phone:'18907052268',state:'1',school:'二七校区',address:'河南省新郑市'},
                {name:'赵泽睿',sex:'男',relation:'母亲',phone:'18907052268',state:'1',school:'二七校区',address:'河南省禹州市'},
                {name:'李千羽',sex:'男',relation:'母亲',phone:'18907052268',state:'1',school:'二七校区',address:'河北省定州市'},
                {name:'龚楚熹 ',sex:'男',relation:'母亲',phone:'18907052268',state:'0',school:'二七校区',address:'江西省宜春市'},
                {name:'龚楚熹 ',sex:'男',relation:'母亲',phone:'18907052268',state:'2',school:'二七校区',address:'天津市静海县'},
                {name:'龚楚熹 ',sex:'男',relation:'母亲',phone:'18907052268',state:'2',school:'二七校区',address:'河南省夏邑县'},
                {name:'龚楚熹 ',sex:'男',relation:'母亲',phone:'18907052268',state:'1',school:'二七校区',address:'安徽省亳州市'},
                {name:'龚楚熹 ',sex:'男',relation:'母亲',phone:'18907052268',state:'1',school:'二七校区',address:'安徽省亳州'},
                {name:'龚楚熹 ',sex:'男',relation:'母亲',phone:'18907052268',state:'1',school:'二七校区',address:'河南省郑州市二七区'},
            ],
        }
    },
    methods:{
